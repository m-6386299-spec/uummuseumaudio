...
const langData = {
  ms: {
    ...
    transcripts: [
      ...
      `,
      `
      <p>Melangkah ke dalam <strong>Zon Sejarah Sintok</strong>, pengunjung seolah-olah dibawa kembali ke <strong>detik-detik penting</strong> yang pernah membentuk <strong>identiti kawasan ini</strong>.Naratif zon ini bukan sekadar menceritakan <strong>perkembangan awal Sintok</strong>, malah turut menyingkap <strong>fasa gelap konflik keselamatan negara</strong>. Suasana tegang <strong>era darurat</strong> dihidupkan melalui penceritaan visual dan <strong>bahan pameran terpilih</strong>, membolehkan pengunjung menghayati <strong>cabaran masyarakat setempat</strong> serta <strong>pasukan keselamatan</strong>.</p>
      <p>Antara <strong>tarikan utama zon ini</strong> ialah <strong>serpihan pejabat polis yang dibakar</strong>, yang menjadi saksi kepada <strong>keganasan dan ancaman Parti Komunis Malaya</strong> terhadap <strong>ketenteraman awam</strong>. Turut dipamerkan ialah <strong>replika kawasan perlombongan bijih timah</strong> yang menggambarkan <strong>kegiatan ekonomi utama Sintok</strong> sebelum terhenti akibat konflik.</p>
      <p>Selain itu, pameran <strong>baju seragam dan senjata anggota polis</strong> semasa <strong>menentang komunis</strong> memberi gambaran jelas tentang <strong>keberanian dan pengorbanan pasukan keselamatan</strong> dalam <strong>mempertahankan negara</strong>. Kesemua <strong>artifak bersejarah ini</strong> bukan sahaja menarik perhatian pengunjung, malah menjadi medium penting untuk <strong>memahami realiti sejarah</strong> serta <strong>menghargai keamanan yang dikecapi hari ini</strong>.</p>      `,
      `
      ...
      <p>Keistimewaan zon ini terserlah melalui <strong>pameran artifak dan simbol kebesaran universiti</strong> yang menjadi saksi kepada <strong>perjalanan sejarah UUM</strong>. Antara artifak paling signifikan ialah <strong>Cokmar Universiti Utara Malaysia</strong>, <strong>simbol kedaulatan dan tradisi akademik</strong> yang telah diserahkan oleh <strong>D.Y.M.M. Seri Paduka Baginda Yang di-Pertuan Agong</strong> melalui <strong>Menteri Pendidikan Malaysia pada tahun 1988</strong>. Reka bentuk <strong>cokmar</strong> yang ringkas namun sarat makna melambangkan <strong>kecergasan dan kedinamikan universiti</strong> dalam <strong>menggalas amanah ilmu</strong>.</p>
      <p>Setiap bahagian <strong>cokmar</strong> membawa <strong>simbolisme tersendiri</strong> daripada <strong>obor keilmuan</strong> yang melambangkan <strong>ilmu yang berterusan</strong>, <strong>bunga padi</strong> sebagai <strong>lambang kebudimanan</strong>, <strong>pena keilmuan</strong> yang menzahirkan <strong>penyebaran ilmu</strong>, hinggalah kepada <strong>keris</strong> yang mencerminkan <strong>ketepatan dan keteguhan dalam mencapai matlamat</strong>. Bersama-sama dengan <strong>dokumen penubuhan</strong>, paparan <strong>pelajar perintis</strong>, serta <strong>mercu tanda seperti Dataran Pewira</strong>, zon ini bukan sekadar menceritakan sejarah, tetapi menghidupkan semula <strong>roh dan maruah Universiti Utara Malaysia</strong> sebagai <strong>institusi ilmu yang berdaulat dan berwibawa</strong>.</p>
      `,
      `
